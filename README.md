...
The UVM 1.2 environment adds reusable packet transactions, a handshake-aware driver, passive input and output monitors, an independent packet and sequence model, a scoreboard and functional coverage. Its five-packet smoke scenario exercises all supported message types, destination rejection, payload backpressure and a sequence gap.
