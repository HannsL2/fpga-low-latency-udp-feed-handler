...
set supported_testbenches [list tb_ethernet_parser tb_ipv4_parser tb_udp_filter tb_market_message_decoder tb_sequence_checker tb_statistics_counters tb_feed_handler_basic tb_feed_handler_uvm]
